...
h2_prompt = ChatPromptTemplate.from_messages([
    HumanMessagePromptTemplate.from_template(
        """Generate a sequence of H2 tags for a blog page on the topic of {topic}. 
...
content_prompt = ChatPromptTemplate.from_messages([
    HumanMessagePromptTemplate.from_template(
        """Generate unique and relevant content for the following H2 tag:
...
html_format_prompt = ChatPromptTemplate.from_messages([
    HumanMessagePromptTemplate.from_template(
        """Convert the following content into HTML format:
